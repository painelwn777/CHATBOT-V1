...
window.CONFIG = {
  ...
  mensagens: {
    ...
    // Após cliente informar nome (COMPACTO - 5 APPS JUNTOS)
    aposNome: `Prazer, {nome}! 😊<br><br>🔥 <b>OFERTA ESPECIAL TIKTOK</b><br><br>📱 <b>Apps Disponíveis:</b><br>• 🟣 <b>Nubank Editável</b> - R$ 9,90<br>• 🟠 <b>Inter Editável</b> - R$ 9,90<br>• 🔴⚫ <b>Nação BRB Fla</b> - R$ 9,90<br>• 🔵 <b>Mercado Pago</b> - R$ 9,90<br>• 🤖 <b>Chatbot WhatsApp</b> - R$ 7,90<br><br>🔥 <b>COMBO 5 Apps</b> - R$ 34,90<br><br><small>⚡ Entrega imediata via PIX!<br>🎁 Menos que um lanche!</small><br><br><b>Como deseja prosseguir?</b><br><div class="action-buttons"><button class="btn-action btn-chatbot" onclick="comprarChatbot('todos')">💳 Comprar Agora</button><button class="btn-action btn-atendente" onclick="solicitarAtendente()">💬 Tirar Dúvidas</button></div>`,
    ...
    // Mensagem do Mercado Pago
    mercadopago: `🔵 <b>Mercado Pago Editável APK</b><br>✅ Totalmente editável<br>✅ Nome, saldo, foto, destinatário<br>✅ PIX de até 20 mil<br>💰 <b>R$ 9,90</b><br>💳 PIX - Entrega na hora<br><br><small>🔥 Mais realista do mercado!</small><br><br><button class="btn-action btn-chatbot" onclick="comprarChatbot('mercadopago')">💳 Comprar Agora</button>`,
    ...
    // Mensagem do Combo (ATUALIZADO - 5 APPS)
    combo: `🔥 <b>COMBO 5 APPS COMPLETO</b><br>🟣 Nubank + 🟠 Inter + 🔴⚫ BRB Fla + 🔵 Mercado Pago + 🤖 Chatbot<br>💰 <b>De R$ 47,50 por R$ 34,90</b><br>💸 Economiza R$ 12,60!<br><br><small>⚡ MAIS VENDIDO! Melhor custo-benefício!<br>🎁 5 apps pelo preço de 4!</small><br><br><button class="btn-action btn-chatbot" onclick="comprarChatbot('combo')">💳 Comprar Agora</button>`,
    ...
    atendimentoEncerrado: `✅ Atendimento encerrado! Voltando ao automático.<br><br>Digite:<br>• <b>Nubank</b> | <b>Inter</b> | <b>BRB</b> | <b>MercadoPago</b> | <b>Combo</b><br>• <b>Atendente</b>`,
    
    // Mensagem padrão (ATUALIZADA COM 5 APPS)
    padrao: `{nome}, digite:<br>• <b>Nubank</b> | <b>Inter</b> | <b>BRB</b> | <b>MercadoPago</b> | <b>Combo</b><br>• <b>Atendente</b> para falar comigo<br>• <b>exit</b> para encerrar<br>• 🎤 para gravar áudio<br>• 📎 para enviar foto/vídeo/APK`,
  ...
  depoimentos: [
    ...
    { imagem: "", legenda: "Mercado Pago é o mais realista! Recomendo!", autor: "Juliana ⭐⭐⭐⭐⭐" }
  ]
};
